    ...
    <>
      ...
      <section className="hero">
        ...
        <p className="hero-sub">
          The platform <strong>28,000+</strong> CS students use to decode every company&apos; recruiting process — real experiences, real timelines, real compensation data.
        ...
        <div className="features-hero-card reveal reveal-delay-3">
          <div className="features-header">
            ...
            <div>
              ...
              >
                Every company gets its own deep page — recruiting timelines, interview breakdowns, round-by-round pass rates, and compensation data. All crowd-sourced and updated in real time.
